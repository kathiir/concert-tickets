...
if __name__ == "__main__":
    ...
    # Пока тут вывод вообще всех полей, нужно будет вычленить только список
    print(sp_instance.current_user_followed_artists(limit=20))

    # Playlist URI to look up
    pl_uri = "spotify:playlist:1JA4Sty28MkHnnw0rcdYtL"
